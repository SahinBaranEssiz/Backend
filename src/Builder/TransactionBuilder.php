...
class TransactionBuilder implements JsonSerializable
{
    ...
    public function __construct($transaction)
    {
        ...
        $this->departure = $transaction->getDeparture()->format('d/m/Y H:i');
        ...
        $this->ticketDate = $transaction->getTicketDate()->format('d/m/Y H:i');
    ...
    public function jsonSerialize()
    {
        return[
            ...
            'has_installment' => $this->isInstallment,
            'dtf' => $this->dtf
        ];
    }
}